...
/* Use to enable frontend visualization. A socket will be triggered.*/
extern int frontend_vis;
/* This is a string containing the prompt that will be displayed by ae. */
